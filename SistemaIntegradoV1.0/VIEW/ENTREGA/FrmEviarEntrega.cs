...
{
    public partial class FrmEviarEntrega : Form
    {
        public FrmEviarEntrega(int idOrcamento)
        {
            InitializeComponent();
        ...
        private void btnEnviarEntrega_Click(object sender, EventArgs e)
        {
            try 
            {
                using (ConnectionString context = new ConnectionString())
                {
                    ...
                    DialogResult result = MessageBox.Show("Produto enviado para entrega", "Sucesso", buttons, MessageBoxIcon.Information);
                    this.Close();
                }
            }
            catch { }
