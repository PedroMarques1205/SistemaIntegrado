...
namespace SistemaIntegradoV1._0
{
    public partial class suprimentos : Form
    {
        ...
        private void suprimentos_Load(object sender, EventArgs e)
        {
            ...
            comboBoxFiltros.Items.Add("Enviados");
            comboBoxFiltros.Items.Add("Não Enviados");
        ...
        public void carregaGrid()
        {
            using (ConnectionString context = new ConnectionString())
            {
                ...
                else if (comboBoxFiltros.Text == "Enviados")
                {
                    var query = (from pedido in context.PedidoCompraSuprimento
                ...
                else if (comboBoxFiltros.Text == "Não Enviados")
                {
                    var query = (from pedido in context.PedidoCompraSuprimento
