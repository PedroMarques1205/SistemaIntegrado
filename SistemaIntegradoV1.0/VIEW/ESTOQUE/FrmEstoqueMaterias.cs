...
{
    public partial class FrmEstoqueMaterias : Form
    {
        public FrmEstoqueMaterias()
        {
            InitializeComponent();
        }
        ...
        public void carregaGrid()
        {
            using (ConnectionString context = new ConnectionString())
            {
                ...
                registrosLabel.Text = "Registros Encontrados " + Convert.ToString(queryMP.ToList().Count);
            }
        }
        ...
        private void materiaDataGridViewe_Click(object sender, EventArgs e)
        {
